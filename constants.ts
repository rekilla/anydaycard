...
export const UNIVERSAL_QUESTIONS: Question[] = [
  ...
  },
  {
    ...
    options: [
      ...
      { label: "Someone I'm dating (it's new)", value: RelationshipType.Dating, icon: '🌱' },
  ...
  },
  {
    ...
    required: true,
    options: [
      { label: 'Their birthday', value: 'Their birthday', icon: '🎂' },
      { label: 'Our anniversary', value: 'Our anniversary', icon: '💞' },
      { label: 'A holiday', value: 'A holiday', icon: '🎁' },
